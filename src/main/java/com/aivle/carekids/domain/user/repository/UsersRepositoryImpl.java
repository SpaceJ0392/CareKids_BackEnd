...
public class UsersRepositoryImpl implements UsersRepositoryCustom {
    ...
    @Override
    public Optional<UsersDto> findUsersDetailWithRegionAndKids(Long usersId) {
        // toOne은 한번에
        UsersDto usersDto = jpaQueryFactory.select(
                        Projections.constructor(
                                UsersDto.class, users.usersId, users.usersEmail, users.usersNickname,
        ...
        Optional<UsersDto> usersDtoOptional = Optional.ofNullable(usersDto);
