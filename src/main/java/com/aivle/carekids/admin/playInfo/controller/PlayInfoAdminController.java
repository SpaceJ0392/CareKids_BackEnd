package com.aivle.carekids.admin.playInfo.controller;

import com.aivle.carekids.admin.playInfo.service.PlayInfoAdminService;
...
public class PlayInfoAdminController {
    ...
    public ResponseEntity<?> displayPlayInfoDetail(@CookieValue(name = "AccessToken") String accessToken,
                                                       @CookieValue(name = "RefreshToken") String refreshToken,
                                                       @PathVariable(name = "id") Long playInfoId) {
    ...
    public ResponseEntity<?> createPlayInfo(@CookieValue(name = "AccessToken") String accessToken,
                                                @CookieValue(name = "RefreshToken") String refreshToken,
                                                @RequestBody PlayInfoDetailDto playInfoDetailDto){
    ...
    public ResponseEntity<?> deletePlayInfo(@CookieValue(name = "AccessToken") String accessToken,
        ...
        return playInfoAdminService.deletePlayInfo(playInfoId);
    }
}
